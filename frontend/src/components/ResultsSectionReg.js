...
const COLORS = ["#FF6F61", "#E0E0E0"];

export default function ResultsSectionReg({ newMetrics, methodType }) {
  ...
  const utilityMetricsKeys = ["mse", "mae", "r2_score"];
              ...
              <Box sx={{ textAlign: "center", pl: 2 }}>
                ...
                >
                  {utilityMetricsKeys.map((key) => {
                    ...
                    const isIncreaseBad = key === "mse" || key === "rse";
                    const isIncreaseGood = key === "r2_score";
                    const isIncrease = change > 0;
                    const isImprovement =
                      (isIncreaseGood && isIncrease) ||
                      (isIncreaseBad && !isIncrease);
                    ...
                    return (
                      ...
                      >
                        ...
                        {key === "r2_score" ? (
                          <>
                            <Tooltip
                              title={`Before: ${beforeValue.toFixed(4)}`}
                            >
                              <LinearProgress
                                variant="determinate"
                                value={Math.max(0, beforeValue * 100)}
                                sx={{
                                  height: 10,
                                  borderRadius: 5,
                            ...
                            <Tooltip title={`After: ${afterValue.toFixed(4)}`}>
                              <LinearProgress
                                variant="determinate"
                                value={Math.max(0, afterValue * 100)}
                                sx={{
                                  mt: 1,
                                  height: 10,
                                  borderRadius: 5,
                        ...
                        >
                          <Box
                            ...
                            sx={{
                              fontSize: "1.5rem",
                              color: isImprovement ? "#82ca9d" : "#FF6F61",
                            }}
                          >
                            {isImprovement ? "↑" : "↓"}
                          </Box>
                      ...
                      >
                        <Box
                          ...
                          sx={{
                            fontSize: "2rem",
                            color:
                              trainingTime.value > 100 ? "#FF6F61" : "#82ca9d",
                          }}
                        >
                          {trainingTime.value > 100 ? "↑" : "↓"}
                        </Box>
