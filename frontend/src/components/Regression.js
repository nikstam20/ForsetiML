...
import BiasMitigationSectionReg from "./BiasMitigationSectionReg";
...
function Regression() {
  ...
  const handleTrainModel = async () => {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:5000/api/model/train_regression_model",
        {
          data_path: dataset,
  ...
  const handleInference = async () => {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:5000/api/model/make_regression_inference",
        {
  ...
  const getMetricDetails = (metricName) => {
    switch (metricName) {
      case "Conditional statistical parity":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Conditional use accuracy equality":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Equal negative predictive value":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Equal opportunity":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Overall accuracy equality":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Predictive equality":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Statistical parity":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Treatment equality":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Balance for positive class":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Equalized odds":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Balance for negative class":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Test fairness":
        return { best: 1, worst: 0, min: 0, max: 1 };
      case "Well calibration":
        return { best: 1, worst: 0, min: 0, max: 1 };
      default:
        return { best: 1, worst: 0, min: 0, max: 1 };
    }
  ...
  const regressionMetrics = [
    {
      ...
      value: metrics.mse,
      formatter: (val) => `${val?.toFixed(4) || "N/A"}`,
    },
    {
    ...
    { label: "R² Score", value: metrics.r2_score, formatter: formatR2Score },
  ];
